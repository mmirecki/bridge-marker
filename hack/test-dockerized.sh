...
docker run --rm -it --privileged --network host --cap-add ALL -v /lib/modules:/lib/modules -v `pwd`:/root/go/src/github.com/mmirecki/bridge-marker -w "/root/go/src/github.com/mmirecki/bridge-marker" ${BUILDER} make test
